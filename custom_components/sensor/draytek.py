...
SENSOR_TYPES = {
    ...
    'NE_Rcvd_Cells' : ['NE_Rcvd_Cells', 'Cells', 'mdi:counter'],
    'NE_Xmitted_Cells' : ['NE_Xmitted_Cells', 'Cells', 'mdi:counter'],
    'NE_CRC_Count' : ['NE_CRC_Count', 'Count', 'mdi:counter'],
    'FE_CRC_Count' : ['FE_CRC_Count', 'Count', 'mdi:counter'],
    'NE_ES_Count' : ['NE_ES_Count', 'Count', 'mdi:counter'],
    'FE_ES_Count' : ['FE_ES_Count', 'Count', 'mdi:counter'],
    'Xdsl_Reset_Times' : ['Xdsl_Reset_Times', 'Count', 'mdi:counter'],
    'Xdsl_Link_Times' : ['Xdsl_Link_Times', 'Count', 'mdi:counter'],
    ...
    'Far_Current_Attenuation' : ['Far_Current_Attenuation', 'dB', 'mdi:signal-variant'],
    'Far_SNR_Margin' : ['Far_SNR_Margin', 'dB', 'mdi:signal-variant'],
